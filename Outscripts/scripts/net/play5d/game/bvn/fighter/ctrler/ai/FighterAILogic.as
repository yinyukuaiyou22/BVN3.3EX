package net.play5d.game.bvn.fighter.ctrler.ai
{
   ...
   public class FighterAILogic extends FighterAILogicBase
   {
      ...
      {
         skill1 = Boolean(_fighterAction.skill1) && getSkillAI("skill1","kj1","kj1mian",10);
         skill2 = Boolean(_fighterAction.skill2) && getSkillAI("skill2","kj2","kj2mian",10);
         zhao1 = Boolean(_fighterAction.zhao1) && getSkillAI("zhao1","zh1","zh1mian",10);
         zhao2 = Boolean(_fighterAction.zhao2) && getSkillAI("zhao2","zh2","zh2mian",10);
         zhao3 = Boolean(_fighterAction.zhao3) && getSkillAI("zhao3","zh3","zh3mian",10);
         skillAIR = Boolean(_fighterAction.skillAIR) && getSkillAI("skillAIR","tz","tzmian",10);
      }
      ...
      {
         bisha = Boolean(_fighterAction.bisha) && getBishaAI("bisha","bs","bsmian",100,100);
         bishaUP = Boolean(_fighterAction.bishaUP) && getBishaAI("bishaUP","sbs","sbsmian",100,100);
         bishaSUPER = Boolean(_fighterAction.bishaSUPER) && getBishaAI("bishaSUPER","cbs","cbsmian",300,200);
         bishaAIR = Boolean(_fighterAction.bishaAIR) && getBishaAI("bishaAIR","kbs","kbsmian",100,210);
      }
      ...
      private function getBishaAI(param1:String, param2:String, param3:String, param4:int, param5:int) : Boolean
      {
         ...
         if(GameConfig.INFINITE_ENERGY || _fighter.qi >= param4)
         {
            if(isBreakAct(param2))
            {
