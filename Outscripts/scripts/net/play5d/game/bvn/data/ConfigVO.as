package net.play5d.game.bvn.data
{
   ...
   public class ConfigVO
   {
      ...
      public function readSaveObj(param1:Object) : void
      {
         ...
         GameConfig.INFINITE_ENERGY = INFINITE_ENERGY;
         Debugger.log("[ConfigVO] readSaveObj() - 加载后 INFINITE_ENERGY = " + INFINITE_ENERGY + ", GameConfig.INFINITE_ENERGY = " + GameConfig.INFINITE_ENERGY);
      }
