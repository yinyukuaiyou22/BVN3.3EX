...
本项目是 **5dplay 出品的"死神vs火影" V1.3** — 基于 ActionScript 3 开发的 2D Flash 格斗游戏。源码从 SWF 反编译后经手动修复，现基于可编译基线持续开发。
...
- `extensions/BVNFileReader/build_ane.bat` — ANE 构建脚本（JavaJARSWCANE）
