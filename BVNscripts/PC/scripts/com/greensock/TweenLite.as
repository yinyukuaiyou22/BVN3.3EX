   ...
   public class TweenLite extends TweenCore
   {
         ...
         if(param1 in masterList)
         {
            ...
            while(--_loc6_ > -1)
            {
               ...
               if(!_loc5_.gc)
               {
                  if(param2)
                  {
                     _loc5_.complete(false,false);
                  }
                  if(param3 != null)
                  {
                     _loc5_.killVars(param3);
                  }
                  if(param3 == null || _loc5_.cachedPT1 == null && _loc5_.initted)
                  {
                     _loc5_.setEnabled(false,false);
                  }
               }
      ...
      protected function init() : void
      {
         ...
         if(_overwrite > 1 && this.cachedPT1)
         {
            ...
            {
               if(overwriteManager.manageOverwrites(this,this.propTweenLookup,_loc2_,_overwrite))
               {
                  init();
               }
            }
