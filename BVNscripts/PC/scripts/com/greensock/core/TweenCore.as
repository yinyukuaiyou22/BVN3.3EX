package com.greensock.core
{
   ...
   public class TweenCore
   {
      ...
      protected function setTotalTime(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.timeline)
         {
            _loc4_ = this.cachedPaused ? this.cachedPauseTime : this.timeline.cachedTotalTime;
            if(this.cachedReversed)
            {
               _loc3_ = this.cacheIsDirty ? this.totalDuration : this.cachedTotalDuration;
               this.cachedStartTime = _loc4_ - (_loc3_ - param1) / this.cachedTimeScale;
            }
            else
            {
               this.cachedStartTime = _loc4_ - param1 / this.cachedTimeScale;
            }
