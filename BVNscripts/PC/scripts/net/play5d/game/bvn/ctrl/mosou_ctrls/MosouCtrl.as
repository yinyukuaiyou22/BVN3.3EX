package net.play5d.game.bvn.ctrl.mosou_ctrls
{
   ...
   public class MosouCtrl
   {
      ...
      public function buildGame() : void
      {
         ...
         _loc4_.putFighter(GameRunFactory.createFighterByMosouData(_loc4_.fighter1,_loc2_[0],"1"));
         _loc4_.putFighter(GameRunFactory.createFighterByMosouData(_loc4_.fighter2,_loc2_[1],"1"));
         _loc4_.putFighter(GameRunFactory.createFighterByMosouData(_loc4_.fighter3,_loc2_[2],"1"));
         _loc4_.currentFighter = _loc4_.getFighter(_loc4_.fighter1);
         var _loc1_:FighterMain = _loc4_.currentFighter;
         var _loc3_:MapMain = GameRunFactory.createMapByData(GameCtrl.I.gameRunData.map);
         if(!_loc1_ || !_loc3_)
         {
         ...
         _loc3_.initlize();
         GameCtrl.I.gameState.initMosouFight(GameCtrl.I.gameRunData.p1FighterGroup,_loc3_);
         GameLogic.initGameLogic(_loc3_,GameCtrl.I.gameState.camera);
      ...
      private function onLevelUp(param1:GameEvent) : void
      {
         ...
         var _loc2_:MosouFighterVO = param1.param;
         var _loc5_:FighterMain = _loc4_.currentFighter;
         if(_loc5_ && _loc5_.mosouPlayerData == _loc2_)
         {
            _loc5_.updateProperties();
            _loc3_ = MosouFighterLogic.ALL_ACTION_LEVELS.indexOf(_loc2_.getLevel());
            if(_loc3_ != -1)
            {
               EffectCtrl.I.doEffectById("level_up_new_act",_loc5_.x,_loc5_.y);
            }
            else
            {
               EffectCtrl.I.doEffectById("level_up",_loc5_.x,_loc5_.y);
            }
         }
      }
      ...
      public function renderAnimate() : void
      {
         ...
         {
            _changeFighterGap = _changeFighterGap - 1;
         }
      }
      ...
      private function renderResumeFighters() : void
      {
         ...
         var _loc1_:Vector.<FighterMain> = GameCtrl.I.gameRunData.p1FighterGroup.getHoldFighters();
         ...
         for each(var _loc2_ in _loc1_)
         {
            ...
            {
               _loc2_.energy += _loc2_.energyMax * 0.08;
               if(_loc2_.energy > _loc2_.energyMax)
               {
                  _loc2_.energy = _loc2_.energyMax;
               }
            }
         }
         _resumeGap = 30;
      ...
      private function renderWaveRepeat() : void
      {
         ...
         var _loc2_:Vector.<MosouWaveRepeatVO> = _runningWave.repeats;
      ...
      private function renderRepeat(param1:MosouWaveRepeatVO) : void
      {
         ...
         var _loc4_:Vector.<MosouEnemyVO> = null;
         ...
         if(param1.type == 1)
         {
            _loc4_ = new Vector.<MosouEnemyVO>();
            for each(var _loc3_ in param1.enemies)
            {
               _loc2_ = getEnemyByData(_loc3_);
         ...
         {
            _loc4_ = param1.enemies;
         }
         if(_loc4_ && _loc4_.length > 0)
         {
            _enemyCreators.push(new EnemyCreator(_loc4_));
         }
      }
      ...
      {
         var _loc2_:IFighterActionCtrl = null;
         if(!param1)
         {
            return;
         }
         if(!param1.initlized())
         {
            ...
            {
               _loc2_ = new EnemyBossAICtrl();
               (_loc2_ as EnemyBossAICtrl).AILevel = 2;
               (_loc2_ as EnemyBossAICtrl).fighter = param1;
            }
            else
            {
               _loc2_ = new EnemyFighterAICtrl();
               (_loc2_ as EnemyFighterAICtrl).fighter = param1;
            }
            param1.initlize();
            param1.setActionCtrl(_loc2_);
         }
         else
         {
            param1.relive();
         ...
         param1.x = Math.random() > 0.5 ? _loc4_.x + _loc5_ : _loc4_.x - _loc5_;
         param1.y = Math.random() > 0.5 ? _loc4_.y + _loc3_ : _loc4_.y - _loc3_;
