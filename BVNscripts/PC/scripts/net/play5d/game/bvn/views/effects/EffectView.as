package net.play5d.game.bvn.views.effects
{
   ...
   public class EffectView
   {
      ...
      public function get data() : EffectVO
      {
         return _data;
      }
      
      public function set data(param1:EffectVO) : void
      {
         _data = param1;
      }
      ...
      private function renderDisplay() : void
      {
         ...
         else
         {
            ...
            if(_rotation != 0)
            {
               ...
               _loc1_ = KyoMath.getPointByRadians(new Point(_loc3_.offsetX,_loc3_.offsetY),_loc2_);
               display.x = _orgX + _loc1_.x;
               display.y = _orgY + _loc1_.y;
            }
            else
            {
