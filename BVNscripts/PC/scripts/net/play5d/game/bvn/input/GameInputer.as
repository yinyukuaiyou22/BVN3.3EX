package net.play5d.game.bvn.input
{
   ...
   public class GameInputer
   {
      ...
      private static function renderListenKeys() : void
      {
         ...
         for each(var _loc4_ in _listenKeys)
         {
            _loc1_ = _loc4_.ids;
            ...
            while(_loc3_ < _loc2_)
            {
               isDown(_loc4_.type,_loc1_[_loc3_],_loc4_.justDown,true);
               _loc3_++;
            }
         }
      }
      ...
      private static function isListenedKey(param1:String, param2:String, param3:int) : Boolean
      {
         ...
         var _loc5_:String = param1 + "_" + param3;
         var _loc6_:Object = _listenKeys[_loc5_];
         if(_loc6_ == null || !_loc6_.ids)
         {
            return false;
         }
         var _loc4_:Array = _loc6_.ids;
         return _loc4_.indexOf(param2) != -1;
      }
      
      public static function render() : void
      {
         for(var _loc1_ in _justDownDelayKeys)
         {
      ...
      public static function special2(param1:String, param2:int = 0) : Boolean
      {
         return isDown(param1,"special2",param2);
      }
      ...
      private static function isJustDownDelay(param1:String, param2:String, param3:Boolean) : Boolean
      {
         ...
         return _justDownDelayKeys[_loc5_] != null && _justDownDelayKeys[_loc5_] > 0;
      }
      ...
      private static function call(param1:String, param2:String, ... rest) : Boolean
      {
         ...
         for each(var _loc4_ in _loc6_)
         {
            if(_loc4_.enabled)
            {
               _loc5_ = _loc4_[param2] as Function;
               if(_loc5_ != null)
               {
      ...
      private static function callVoid(param1:String, ... rest) : void
      {
         ...
         for each(var _loc5_ in _inputMap)
         {
            for each(var _loc3_ in _loc5_)
            {
               if(_loc3_.enabled)
               {
                  _loc4_ = _loc3_[param1] as Function;
                  if(_loc4_ != null)
                  {
