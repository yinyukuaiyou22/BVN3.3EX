package net.play5d.game.bvn.ui.mosou
{
   ...
   public class MosouUI implements IGameUI
   {
      ...
      {
         super();
         _ui = AssetManager.I.createObject("ui_mosou","subswfs/musou.swf") as MovieClip;
      ...
      public function setBossHp(param1:FighterMain) : void
      {
         if(param1 != null)
         {
            ...
            for each(var _loc2_ in _bosses)
            {
               if(_loc2_ != param1)
               {
      ...
      public function updateBossHp() : void
      {
         ...
         for each(var _loc2_ in _bosses)
         {
            if(!_loc2_.isAlive || !_loc2_.getActive())
            {
               _loc1_ = _bosses.indexOf(_loc2_);
               if(_loc1_ != -1)
               {
                  _bosses.splice(_loc1_,1);
               }
            }
         }
         if(_bosses.length < 1)
