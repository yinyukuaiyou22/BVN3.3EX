package net.play5d.game.bvn.ui.select
{
   ...
   public class SelectedFighterUI extends EventDispatcher
   {
      ...
      public function SelectedFighterUI(param1:Sprite)
      {
         ...
         {
            _text = new TextField();
            _text.filters = [new GlowFilter(0,1,3,3,3)];
            _loc2_ = {
               "color":16777215,
               "size":14,
               "align":"right"
            };
            _loc3_ = AssetManager.I.getSWFEffectClass("selected_item_p1_mc","subswfs/select.swf");
            if(param1 is _loc3_)
            {
               UIUtils.formatText(_text,_loc2_);
      ...
      public function setFighter(param1:FighterVO) : void
      {
         ...
         var _loc2_:DisplayObject = ui.getChildByName("ct");
      ...
      public function setFighterIndex(param1:int) : void
      {
         ...
         var _loc2_:MovieClip = AssetManager.I.createObject("seltwzmc","assets/subswfs/loading.swf") as MovieClip;
         _loc2_.gotoAndStop(param1);
         ui.addChild(_loc2_);
         var _loc3_:Class = AssetManager.I.getSWFEffectClass("selected_item_p1_mc","subswfs/select.swf");
         if(ui is _loc3_)
         {
            _loc2_.x = -8;
         }
      ...
      {
         var _loc1_:MovieClip = AssetManager.I.createObject("seltwzmc","assets/subswfs/loading.swf") as MovieClip;
         _loc1_.gotoAndStop(4);
         var _loc2_:Class = AssetManager.I.getSWFEffectClass("selected_item_p1_mc","subswfs/select.swf");
         ui.addChild(_loc1_);
         if(ui is _loc2_)
         {
            _loc1_.x = -8;
