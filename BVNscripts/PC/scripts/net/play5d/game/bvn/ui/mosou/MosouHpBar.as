package net.play5d.game.bvn.ui.mosou
{
   ...
   public class MosouHpBar
   {
      ...
      public function render() : void
      {
         ...
         var _loc3_:Number = _fighter.hpRate;
         if(_redBarMoving && _loc3_ != _hprate)
         {
            _bar2.scaleX = _hprate;
            _redBarMoving = false;
         }
         _hprate = _loc3_;
         var _loc5_:Number = _hprate - _bar.scaleX;
         var _loc1_:Number = _loc5_ < 0 ? 0.4 : 0.04;
