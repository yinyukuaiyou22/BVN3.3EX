package net.play5d.game.bvn.ui.mosou
{
   ...
   public class CoinUI
   {
      ...
      {
         GameUI.alert(GetLangText("game_ui.alert.musou_add_money.title"),GetLangText("game_ui.alert.musou_add_money.message_prefix") + param1 + GetLangText("game_ui.alert.musou_add_money.message_suffix"),null,true);
