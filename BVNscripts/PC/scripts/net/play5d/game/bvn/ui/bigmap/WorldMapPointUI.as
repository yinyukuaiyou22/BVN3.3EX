package net.play5d.game.bvn.ui.bigmap
{
   ...
   public class WorldMapPointUI extends EventDispatcher
   {
      ...
      private function updateFace() : void
      {
         ...
         var _loc1_:MosouFighterVO = GameData.I.mosouData.getLeader();
         if(!_loc1_)
         {
            return;
         }
         var _loc2_:DisplayObject = AssetManager.I.getFighterFace(FighterModel.I.getFighter(_loc1_.id));
         if(_loc2_)
         {
            _loc2_.x = 1;
         ...
         _lvTxt.text = "Lv." + _loc1_.getLevel();
         _lvTxt.visible = true;
         _facemc.scaleY = 0.01;
         _facemc.scaleX = 0.01;
         TweenLite.to(_facemc,0.1,{
