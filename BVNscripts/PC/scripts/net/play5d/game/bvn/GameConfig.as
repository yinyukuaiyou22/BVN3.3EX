package net.play5d.game.bvn
{
   ...
   public class GameConfig
   {
      ...
      public static var IS_WIN_ACTIVATE:Boolean = true;
      
      public static var IS_QUICK_LOAD:Boolean = true;
      
      public static var IS_SINGLE_STEP:Boolean = false;
      
      public static var IS_LOW_QUALITY:Boolean = false;
      ...
      public static const ENERGY_ADD_JUMPING:Number = 0;
