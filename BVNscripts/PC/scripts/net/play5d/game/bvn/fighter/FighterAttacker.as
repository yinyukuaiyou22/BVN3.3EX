package net.play5d.game.bvn.fighter
{
   ...
   public class FighterAttacker extends BaseGameSprite
   {
      ...
      public function FighterAttacker(param1:MovieClip, param2:Object = null, param3:IGameSprite = null)
      {
         super(param1);
         ...
         x = _startX;
         y = _startY;
         _ctrler = new FighterAttackerCtrler(this,param3);
         _ctrler.effect = new FighterEffectCtrl(this);
         ...
         if(param2)
         {
            ...
            if(param2.allowCrossFloor != undefined)
            {
               isAllowCrossFloor = param2.allowCrossFloor == true;
            }
         }
      }
         ...
         if(_loc6_)
         {
            ...
            if(moveToTargetY)
            {
               ...
               if(rangeY)
               {
                  ...
                  if(_loc5_ < rangeY.x)
                  {
                     _loc3_ = _owner.y + rangeY.x;
                  }
                  if(_loc5_ > rangeY.y)
                  {
                     _loc3_ = _owner.y + rangeY.y;
                  }
               }
               y = _loc3_;
            }
      ...
      private function findHitArea() : void
      {
         ...
         var _loc7_:FighterHitModel = getHitModel();
         if(_loc7_ == null)
         {
            return;
         }
         ...
         while(_loc6_ < _mainMc.numChildren)
         {
            ...
            _loc8_ = _loc7_.getHitVOByDisplayName(_loc4_.name);
      ...
      override public function hit(param1:HitVO, param2:IGameSprite) : void
      {
         ...
         if(param2 && _loc3_)
         {
            ...
            if(param2 is FighterMain && param2 == _ctrler.getTargetFighter())
            {
