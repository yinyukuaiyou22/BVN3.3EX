package net.play5d.game.bvn.fighter.ctrler
{
   ...
   public class FighterKeyCtrl implements IFighterActionCtrl
   {
      ...
      public var justAssistFrame:int = 0;
      
      public var justSpecialFrame:int = 0;
      ...
      {
         if(justAssistFrame > 0)
         {
            justAssistFrame = justAssistFrame - 1;
         }
         if(justSpecialFrame > 0)
         {
            justSpecialFrame = justSpecialFrame - 1;
         }
      }
      ...
      {
         return GameInputer.up(inputType,0) && !GameInputer.down(inputType,0);
      }
      
      public function moveDOWN() : Boolean
      {
         return GameInputer.down(inputType,0) && !GameInputer.up(inputType,0);
      }
      ...
      {
         return GameInputer.attack(inputType,_justDown) && !(GameInputer.up(inputType,0) || GameInputer.down(inputType,0));
      }
      
      public function jump() : Boolean
      {
         return GameInputer.jump(inputType,_justDown) && (!GameInputer.down(inputType,0) || GameInputer.down(inputType,0) && (GameInputer.attack(inputType,0) || GameInputer.skill(inputType,0) || GameInputer.superSkill(inputType,0)));
      }
      ...
      public function jumpQuick() : Boolean
      {
         ...
         return GameInputer.jump(inputType,_justDown) && !GameInputer.down(inputType,0);
      }
      ...
      {
         return GameInputer.dash(inputType,_justDown) && !(GameInputer.up(inputType,0) || GameInputer.down(inputType,0));
      }
      ...
      {
         return GameInputer.attack(inputType,2) && (GameInputer.left(inputType,0) || GameInputer.right(inputType,0)) && !GameInputer.down(inputType,0) && !GameInputer.up(inputType,0);
      }
      
      public function catch2() : Boolean
      {
         return GameInputer.skill(inputType,2) && (GameInputer.left(inputType,0) || GameInputer.right(inputType,0)) && !GameInputer.down(inputType,0) && !GameInputer.up(inputType,0);
      }
      ...
      {
         if(GameData.I.config.isSpecialMisProt && justSpecialFrame > 0)
         {
            return false;
         }
      ...
      {
         if(GameData.I.config.isSpecialMisProt && justAssistFrame > 0)
         {
            return false;
         }
         if(GameData.I.config.isReplaceSpecial)
         {
            return GameInputer.special(inputType,0) && (GameInputer.up(inputType,0) || GameInputer.down(inputType,0));
         }
         return GameInputer.special2(inputType,0);
      }
      ...
      {
         return GameInputer.attack(inputType,0);
      }
      
      public function holdSkill() : Boolean
      {
         return GameInputer.skill(inputType,0);
      }
      
      public function holdBisha() : Boolean
      {
         return GameInputer.superSkill(inputType,0);
      }
