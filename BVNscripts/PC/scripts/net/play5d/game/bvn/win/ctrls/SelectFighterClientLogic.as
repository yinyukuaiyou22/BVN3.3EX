package net.play5d.game.bvn.win.ctrls
{
   ...
   public class SelectFighterClientLogic
   {
      ...
      public function receiveSelect(param1:Object) : Boolean
      {
         ...
         switch((_loc3_ = int(_loc4_[1])) - 1)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               onSelectFighter(_loc4_);
               break;
            case 3:
               receiveSelectIndex(_loc4_);
               break;
            case 4:
               onSelectFighterIndexFinish(_loc4_);
         }
         return true;
      }
      ...
      {
         var _loc2_:LoadingStage = MainGame.stageCtrl.currentStage as LoadingStage;
         if(_loc2_)
         {
      ...
      private function onSelectFighterIndexFinish(param1:Array) : void
      {
         ...
         {
            LoadingStage.gotoGame(param1[2],param1[3]);
         }
      }
   }
}
