package net.play5d.game.bvn.win.ctrls
{
   ...
   public class LockFrameServerLogic
   {
      ...
      private function getSyncUpdate() : ByteArray
      {
         ...
         if(_loc3_ is GameStage)
         {
            if(GameCtrl.I.actionEnable)
            {
               _loc4_ = GameCtrl.I.gameRunData;
               _loc1_ = _loc4_.p1FighterGroup.currentFighter;
               _loc5_ = _loc4_.p2FighterGroup.currentFighter;
               _loc2_ = new ByteArray();
               _loc2_.writeByte(10);
               _loc2_.writeShort(_renderFrame);
               _loc2_.writeByte(_loc4_.round);
               _loc2_.writeByte(_loc4_.gameTime);
               _loc2_.writeShort(_loc1_.hp << 0);
               _loc2_.writeShort(_loc1_.qi << 0);
               _loc2_.writeShort(_loc1_.x << 0);
               _loc2_.writeShort(_loc1_.y << 0);
