      ...
      public function receiveSelect(param1:Object) : Boolean
      {
         ...
         switch((_loc4_ = int(param1[1])) - 1)
         {
            ...
            case 3:
               try
               {
                  _loc5_ = MainGame.stageCtrl.currentStage as LoadingState;
                  _loc5_.setOrder(2,param1[2]);
