package net.play5d.game.bvn.ui.fight
{
   ...
   public class FightFaceGroup
   {
      ...
      public function FightFaceGroup(param1:hpbar_facegroup)
      {
         super();
         _ui = param1;
      ...
      public function setFighter(param1:GameRunFighterGroup = null) : void
      {
         ...
         switch(param1.currentFighter)
         {
            case param1.fighter1:
               _face2.setData(param1.fighter2 ? param1.fighter2.data : null);
               _face3.setData(param1.fighter3 ? param1.fighter3.data : null);
               break;
            case param1.fighter2:
               _face2.setData(param1.fighter3 ? param1.fighter3.data : null);
               _face3.setData(null);
               break;
